...
import 'package:job_seeker/features/home/widgets/job_details_dialog.dart';
          ...
          child: Column(
            children: [
              Obx(
                () => RadioTile(
                  radioVal: 1,
                  groupVal: resumeController.generateLetterRadioSelected.value,
                  ...
                  changeVal: resumeController.changeLetterRadio,
                ),
              ),
              SizedBox(height: 10),
              Obx(
              ...
              ActionButton(
                buttonText: 'Continue',
                onPress: () {
                  if (resumeController.generateLetterRadioSelected.value == 1) {
                    Get.back();
